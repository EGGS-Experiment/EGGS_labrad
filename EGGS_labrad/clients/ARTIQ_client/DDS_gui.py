...
class AD9910_channel(QFrame):
    ...
    def makeLayout(self, title):
        ...
        name.setFont(QFont(SHELL_FONT, pointSize=8))
        name.setAlignment(Qt.AlignRight | Qt.AlignTop)

        title = QCustomEditableLabel(title)
        title.setFont(QFont(SHELL_FONT, pointSize=13))
        ...
        self.freq.setFont(QFont(SHELL_FONT, pointSize=13))
        ...
        self.ampl.setFont(QFont(SHELL_FONT, pointSize=13))
        ...
        self.att.setFont(QFont(SHELL_FONT, pointSize=13))
        ...
        self.initbutton.setFont(QFont(SHELL_FONT, pointSize=10))
...
class DDS_gui(QFrame):
    ...
    def _makeUrukulGroup(self, urukul_name, ad9910_list):
        ...
        init_cpld.setFont(QFont(SHELL_FONT, pointSize=10))
