...
class lakeshore336_gui(QFrame):
    ...
    def setupUi(self):
        ...
        lakeshore336_gui.setFixedSize(517, 500)
        lakeshore336_gui.setFrameStyle(0x0001 | 0x0030)
        self.lakeshore_label = QLabel(lakeshore336_gui)
        self.lakeshore_label.setGeometry(QRect(30, 20, 471, 31))
        font = QFont()
        font.setPointSize(18)
        self.lakeshore_label.setFont(font)
        self.lakeshore_label.setObjectName("lakeshore_label")
        self.heatAll_label = QLabel(lakeshore336_gui)
        self.heatAll_label.setGeometry(QRect(270, 70, 191, 31))
        font = QFont()
        font.setPointSize(15)
        self.heatAll_label.setFont(font)
        self.heatAll_label.setObjectName("heatAll_label")
        self.tempAll_label = QLabel(lakeshore336_gui)
        self.tempAll_label.setGeometry(QRect(10, 70, 209, 24))
        font = QFont()
        font.setPointSize(15)
        ...
        self.heatAll_lockswitch.setGeometry(QRect(290, 110, 139, 23))
        ...
        QMetaObject.connectSlotsByName(lakeshore336_gui)
    ...
    def retranslateUi(self, lakeshore336_gui):
        ...
        self.heat1_mode.setItemText(1, _translate("lakeshore336_gui", "PID"))
        self.heat1_mode.setItemText(2, _translate("lakeshore336_gui", "Zone"))
        self.heat1_mode.setItemText(3, _translate("lakeshore336_gui", "Open Loop"))
        self.heat1_in_label.setText(_translate("lakeshore336_gui", "Input"))
        self.heat1_in.setItemText(0, _translate("lakeshore336_gui", "0"))
        self.heat1_in.setItemText(1, _translate("lakeshore336_gui", "1"))
        self.heat1_in.setItemText(2, _translate("lakeshore336_gui", "2"))
        self.heat1_in.setItemText(3, _translate("lakeshore336_gui", "3"))
        self.heat1_in.setItemText(4, _translate("lakeshore336_gui", "4"))
        ...
        self.heat1_range_label.setText(_translate("lakeshore336_gui", "Range (% of max)"))
        self.heat1_range.setItemText(0, _translate("lakeshore336_gui", "Off"))
        self.heat1_range.setItemText(1, _translate("lakeshore336_gui", "1%"))
        self.heat1_range.setItemText(2, _translate("lakeshore336_gui", "10%"))
        self.heat1_range.setItemText(3, _translate("lakeshore336_gui", "100%"))
        ...
        self.heat2_mode.setItemText(1, _translate("lakeshore336_gui", "PID"))
        self.heat2_mode.setItemText(2, _translate("lakeshore336_gui", "Zone"))
        self.heat2_mode.setItemText(3, _translate("lakeshore336_gui", "Open Loop"))
        self.heat2_in_label.setText(_translate("lakeshore336_gui", "Input"))
        self.heat2_in.setItemText(0, _translate("lakeshore336_gui", "0"))
        self.heat2_in.setItemText(1, _translate("lakeshore336_gui", "1"))
        self.heat2_in.setItemText(2, _translate("lakeshore336_gui", "2"))
        self.heat2_in.setItemText(3, _translate("lakeshore336_gui", "3"))
        self.heat2_in.setItemText(4, _translate("lakeshore336_gui", "4"))
        ...
        self.heat2_range_label.setText(_translate("lakeshore336_gui", "Range (% of max)"))
        self.heat2_range.setItemText(0, _translate("lakeshore336_gui", "Off"))
        self.heat2_range.setItemText(1, _translate("lakeshore336_gui", "1%"))
        self.heat2_range.setItemText(2, _translate("lakeshore336_gui", "10%"))
        self.heat2_range.setItemText(3, _translate("lakeshore336_gui", "100%"))
