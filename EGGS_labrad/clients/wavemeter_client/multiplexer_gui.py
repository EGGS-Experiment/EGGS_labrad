...
class multiplexer_pid(QFrame):
    ...
    def makeLayout(self, DACPort):
        ...
        layout.addWidget(PIDlabel,      0, 0, 1, 1)
        layout.addWidget(pLabel,        1, 0, 1, 1)
        layout.addWidget(self.spinP,    2, 0, 1, 1)
        layout.addWidget(iLabel,        3, 0, 1, 1)
