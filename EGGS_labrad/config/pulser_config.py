# imports
from EGGS_labrad.servers.pulser.sequence.pulser_config import channelConfiguration as ChConfig
from EGGS_labrad.servers.pulser.sequence.pulser_config import ddsConfiguration as ddsConfig
