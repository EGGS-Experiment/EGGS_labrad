...
def get_argparser():
    parser = argparse.ArgumentParser(description="LabRAD Master")
    parser.add_argument(
        "-s",
        help="start all day-to-day servers (specific to EGGS Experiment)")
    parser.add_argument(
        "-r", default=None, type=int,
        help="start only the labrad core (i.e. the manager, a node, and the Chromium GUI)")
