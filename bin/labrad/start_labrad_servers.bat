...
START "FMA Server" /min CMD "/k activate labart && python %LABRAD_ROOT%\lib\servers\cryovac\fma1700a_server.py"

REM: Trap
START "RF Server" /min CMD "/k activate labart && python %LABRAD_ROOT%\lib\servers\trap\rf_server.py"
START "DC Server" /min CMD "/k activate labart && python %LABRAD_ROOT%\lib\servers\trap\dc_server.py"
