...
START "RGA Server" /min CMD "/k activate labart && python %LABRAD_ROOT%/servers/cryovac/rga_server.py"

::Trap
START "RF Server" /min CMD "/k activate labart && python %LABRAD_ROOT%/servers/trap/rf_server.py"

::Lasers
START "SLS Server" /min CMD "/k activate labart && python %LABRAD_ROOT%/servers/lasers/sls_server.py"
