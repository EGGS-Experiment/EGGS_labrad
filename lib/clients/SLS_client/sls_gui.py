...
class SLS_gui(QWidget):
    def setupUi(self):
        ...
        self.PDH_layout.addWidget(self.PDH_phaseoffset, 2, 1, 1, 1)
        ...
        self.PDH_filter.addItem("")
        self.PDH_filter.addItem("")
        self.PDH_layout.addWidget(self.PDH_filter, 3, 1, 1, 1)
        ...
        self.PDH_layout.addWidget(self.PDH_phasemodulation, 1, 1, 1, 1)
        self.PDH_freq_label = QtWidgets.QLabel(self.widget)
        self.PDH_freq_label.setObjectName("PDH_freq_label")
        self.PDH_layout.addWidget(self.PDH_freq_label, 0, 0, 1, 1)
        ...
        self.PDH_layout.addWidget(self.PDH_freq, 0, 1, 1, 1)
        self.widget1 = QtWidgets.QWidget(SLS_gui)
        self.widget1.setGeometry(QtCore.QRect(730, 210, 301, 261))
        ...
        self.servo_layout.addWidget(self.servo_i, 2, 1, 1, 1)
        self.servo_set_label = QtWidgets.QLabel(self.widget1)
        self.servo_set_label.setObjectName("servo_set_label")
        self.servo_layout.addWidget(self.servo_set_label, 4, 0, 1, 1)
        ...
        self.servo_param.addItem("")
        self.servo_param.addItem("")
        self.servo_layout.addWidget(self.servo_param, 0, 1, 1, 1)
        self.servo_filter_label = QtWidgets.QLabel(self.widget1)
        self.servo_filter_label.setObjectName("servo_filter_label")
        self.servo_layout.addWidget(self.servo_filter_label, 5, 0, 1, 1)
        self.widget2 = QtWidgets.QWidget(SLS_gui)
        self.widget2.setGeometry(QtCore.QRect(20, 210, 271, 151))
        ...
        self.autolock_layout.addWidget(self.PDH_phasemodulation_label_4, 4, 0, 1, 1)
