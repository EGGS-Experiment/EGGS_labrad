...
class RGA_gui(QFrame):
    ...
    def setupUi(self):
        ...
        self.layoutWidget_3.setGeometry(QtCore.QRect(160, 228, 131, 151))
        ...
        self.detector_hv_label = QtWidgets.QLabel(self.layoutWidget_3)
        self.detector_hv_label.setObjectName("detector_hv_label")
        self.detector_layout.addWidget(self.detector_hv_label, 3, 1, 1, 1)
        ...
        self.ionizer_ee.setSingleStep(1)
        self.ionizer_ee.setMinimum(25)
        self.ionizer_ee.setMaximum(105)
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(450, 70, 181, 310))
    ...
    def retranslateUi(self, RGA_gui):
        ...
        self.detector_hv_label.setText(_translate("RGA_gui", "CDEM Voltage (V)"))
