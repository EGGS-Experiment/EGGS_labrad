...
class RGA_gui(QFrame):
    ...
    def setupUi(self):
        ...
        self.general_lockswitch = TextChangingButton(('Unlocked', 'Locked'), self.layoutWidget)
        ...
        self.scan_lockswitch = TextChangingButton(('Unlocked', 'Locked'), self.layoutWidget_4)
        ...
        self.detector_lockswitch = TextChangingButton(('Unlocked', 'Locked'), self.layoutWidget_3)
        ...
        self.ionizer_lockswitch = TextChangingButton(('Unlocked', 'Locked'), self.layoutWidget1)
