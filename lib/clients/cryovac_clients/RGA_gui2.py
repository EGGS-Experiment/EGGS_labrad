...
class Ui_RGA_gui(object):
    def setupUi(self, RGA_gui):
        ...
        RGA_gui.resize(649, 444)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(RGA_gui.sizePolicy().hasHeightForWidth())
        RGA_gui.setSizePolicy(sizePolicy)
        ...
        self.ionizer_vf.setDecimals(2)
        self.ionizer_vf.setMinimum(0.0)
        self.ionizer_vf.setMaximum(150.0)
        self.ionizer_vf.setSingleStep(0.1)
