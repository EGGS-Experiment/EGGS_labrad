...
class lakeshore336_gui(QFrame):
    ...
    def setupUi(self):
        ...
        self.heat1_out_curr_label = QtWidgets.QLabel(parent=self.layoutWidget1)
        self.heat1_out_curr_label.setObjectName("heat1_out_curr_label")
        self.heat1_layout.addWidget(self.heat1_out_curr_label)
        self.heat1_out_curr = QtWidgets.QLabel('Current 1', self.layoutWidget1)
        self.heat1_out_curr.setFont(QFont(shell_font, pointSize=16))
        self.heat1_out_curr.setStyleSheet('color: red')
        ...
        self.heat2_out_curr = QtWidgets.QLabel('Current 2', self.layoutWidget1)
        self.heat2_out_curr.setObjectName("heat2_out_curr")
        self.heat2_out_curr.setAlignment(QtCore.Qt.AlignCenter)
        self.heat2_out_curr.setFont(QFont(shell_font, pointSize=16))
        self.heat2_out_curr.setStyleSheet('color: red')
    ...
    def retranslateUi(self, lakeshore336_gui):
        ...
        self.heat2_out_curr_label.setText(_translate("lakeshore336_gui", "Output Current (A)"))
