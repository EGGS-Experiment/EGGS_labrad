...
# Form implementation generated from reading ui file 'lakeshore336_gui.ui'
#
...
class lakeshore336_gui(QFrame):
    ...
    def setupUi(self):
        ...
        self.heatAll_label.setGeometry(QtCore.QRect(300, 70, 201, 31))
        font = QtGui.QFont()
        ...
        self.temp_layout = QtWidgets.QVBoxLayout(self.widget)
        self.temp_layout.setContentsMargins(0, 0, 0, 0)
        self.temp_layout.setObjectName("temp_layout")
        self.temp1_label = QtWidgets.QLabel(self.widget)
        ...
        self.temp2 = QtWidgets.QLabel(self.widget)
        ...
        self.widget1 = QtWidgets.QWidget(lakeshore336_gui)
        self.widget1.setGeometry(QtCore.QRect(240, 150, 321, 428))
        self.widget1.setObjectName("widget1")
        self.heatAll_layout = QtWidgets.QHBoxLayout(self.widget1)
        ...
        self.heat1_label = QtWidgets.QLabel(self.widget1)
        font = QtGui.QFont()
        ...
        self.heat1_in_label = QtWidgets.QLabel(self.widget1)
        self.heat1_in_label.setObjectName("heat1_in_label")
        self.heat1_layout.addWidget(self.heat1_in_label)
        self.heat1_in = QtWidgets.QComboBox(self.widget1)
        ...
        self.heat1_set_label = QtWidgets.QLabel(self.widget1)
        self.heat1_set_label.setObjectName("heat1_set_label")
        self.heat1_layout.addWidget(self.heat1_set_label)
        self.heat1_set = QtWidgets.QDoubleSpinBox(self.widget1)
        self.heat1_set.setObjectName("heat1_set")
        self.heat1_layout.addWidget(self.heat1_set)
        self.heat1_p1_label = QtWidgets.QLabel(self.widget1)
        self.heat1_p1_label.setObjectName("heat1_p1_label")
        self.heat1_layout.addWidget(self.heat1_p1_label)
        self.heat1_p1 = QtWidgets.QDoubleSpinBox(self.widget1)
        self.heat1_p1.setObjectName("heat1_p1")
        self.heat1_layout.addWidget(self.heat1_p1)
        self.heat1_p2_label = QtWidgets.QLabel(self.widget1)
        self.heat1_p2_label.setObjectName("heat1_p2_label")
        self.heat1_layout.addWidget(self.heat1_p2_label)
        self.heat1_p2 = QtWidgets.QDoubleSpinBox(self.widget1)
        self.heat1_p2.setObjectName("heat1_p2")
        self.heat1_layout.addWidget(self.heat1_p2)
        self.heat1_p3_label = QtWidgets.QLabel(self.widget1)
        self.heat1_p3_label.setObjectName("heat1_p3_label")
        self.heat1_layout.addWidget(self.heat1_p3_label)
        self.heat1_p3 = QtWidgets.QDoubleSpinBox(self.widget1)
        self.heat1_p3.setObjectName("heat1_p3")
        self.heat1_layout.addWidget(self.heat1_p3)
        ...
        self.heat2_label = QtWidgets.QLabel(self.widget1)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.heat2_in_label = QtWidgets.QLabel(self.widget1)
        self.heat2_in_label.setObjectName("heat2_in_label")
        self.heat2_layout.addWidget(self.heat2_in_label)
        self.heat2_in = QtWidgets.QComboBox(self.widget1)
        ...
        self.heat2_set_label = QtWidgets.QLabel(self.widget1)
        self.heat2_set_label.setObjectName("heat2_set_label")
        self.heat2_layout.addWidget(self.heat2_set_label)
        self.heat2_set = QtWidgets.QDoubleSpinBox(self.widget1)
        self.heat2_set.setObjectName("heat2_set")
        self.heat2_layout.addWidget(self.heat2_set)
        self.heat2_p1_label = QtWidgets.QLabel(self.widget1)
        self.heat2_p1_label.setObjectName("heat2_p1_label")
        self.heat2_layout.addWidget(self.heat2_p1_label)
        self.heat2_p1 = QtWidgets.QDoubleSpinBox(self.widget1)
        self.heat2_p1.setObjectName("heat2_p1")
        self.heat2_layout.addWidget(self.heat2_p1)
        self.heat2_p2_label = QtWidgets.QLabel(self.widget1)
        self.heat2_p2_label.setObjectName("heat2_p2_label")
        self.heat2_layout.addWidget(self.heat2_p2_label)
        self.heat2_p2 = QtWidgets.QDoubleSpinBox(self.widget1)
        self.heat2_p2.setObjectName("heat2_p2")
        self.heat2_layout.addWidget(self.heat2_p2)
        self.heat2_p3_label = QtWidgets.QLabel(self.widget1)
        self.heat2_p3_label.setObjectName("heat2_p3_label")
        self.heat2_layout.addWidget(self.heat2_p3_label)
        self.heat2_p3 = QtWidgets.QDoubleSpinBox(self.widget1)
        self.heat2_p3.setObjectName("heat2_p3")
        self.heat2_layout.addWidget(self.heat2_p3)
    ...
    def retranslateUi(self, lakeshore336_gui):
        ...
        self.heat1_p1_label.setText(_translate("lakeshore336_gui", "Parameter 1"))
        self.heat1_p2_label.setText(_translate("lakeshore336_gui", "Parameter 2"))
        self.heat1_p3_label.setText(_translate("lakeshore336_gui", "Parameter 3"))
