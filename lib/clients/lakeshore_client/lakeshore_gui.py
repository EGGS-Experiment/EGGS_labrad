...
class software_laser_lock_channel(QFrame):
    ...
    def makeLayout(self, name):
        ...
        self.wavelength.setFont(QFont(shell_font, pointSize=70))
        ...
        lockName.setFont(QFont(shell_font, pointSize=16))
        lockName.setAlignment(QtCore.Qt.AlignCenter)

        # frequency
        self.spinFreq1 = QDoubleSpinBox()
        self.spinFreq1.setFont(QFont(shell_font, pointSize=16))
        ...
        self.spinExposure.setFont(QFont(shell_font, pointSize=16))
        ...
        self.dacLabel.setFont(QFont('MS Shell Dlg 2', pointSize=30))
        self.dacLabel.setAlignment(QtCore.Qt.AlignCenter)

        self.dacVoltage = QLabel('0.0')
        self.dacVoltage.setFont(QFont('MS Shell Dlg 2', pointSize=30))
