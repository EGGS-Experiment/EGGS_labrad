...
class vibration_measurement(experiment):
    ...
    def set_up_datavault(self):
        ...
        dataset_temp = self.dv.new('Lakeshore 336 Temperature Controller',[('time', 't')], [('Temperature Diode 1', 'Temperature', 'K')],\
                                   [('Temperature Diode 2', 'Temperature', 'K')], [('Temperature Diode 3', 'Temperature', 'K')], \
                                   [('Temperature Diode 4', 'Temperature', 'K')], context = self.c_result)
