...
class ElectrodeServer(LabradServer):
    """
    Manages communication with the trap electrodes via the DACs on ARTIQ.
    This is done in a manner similar to the ARTIQ Pulser server.
    """

    name = 'Electrode Server'
    regKey = 'Electrode_Server'
